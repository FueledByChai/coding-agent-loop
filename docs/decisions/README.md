...
- [0025](0025-require-whole-job-lifecycle-stop-proof-before-releasing-work.md) Require whole-job lifecycle stop proof before releasing worker ownership — accepted
